<?php // 9a6e6440acf74ad9ec1dd1f548198a1cc346aae4 (indicators: trainings)
...
class ETBUIndicatorsComputer1 extends ProjectIndicatorsComputer
{
    public function compute($request, $customAccess, $new, $datesOnlyQuery, $datesQuery)
    {
        $totalServices = $this->getServicesCountByProfileField('6g6x', 'HeBk', [], $request, 'notin');
        $totalVulnerableServices = $this->getServicesCountByProfileField(null, null, [], $request, '=', null, 2);
        ...
        if ($new) {
            list(
                ...
                $parentMenNew,
                $parentWomenNew
            ) = $this->getCountsByProfileField('6g6x', 'aSu3', [], $request, 'contains', null, false, true);
        } else {
            $parentsNew = null;
            $parentMenNew = null;
            $parentWomenNew = null;
        ...
        foreach ($fullChildrenQuery->get() as $item) {
            ...
            if (!empty($item->profile[6][0]->data['GWQS'])
                ...
                $start3 = $request->from && $request->from > $item->profile[6][0]->data['GWQS']
                ...
                if (count($soc3) || count($psy3)) {
                    ...
                    $fullChildren11Services = $fullChildren11Services->concat($psy3ids)->concat($soc3ids);
                    ...
                    if (count($soc3)) {
                        $fullChildren18++;
                        $fullChildren18Services = $fullChildren18Services->concat($soc3ids);
                    }
            ...
            if ((!$request->till || $request->till >= $item->profile[6][0]->data['kB3w'])
                ...
                if (count($soc4) || count($psy4)) {
                    ...
                    $fullChildren12Services = $fullChildren12Services->concat($psy4ids)->concat($soc4ids);
                    ...
                    if (count($soc4)) {
                        $fullChildren16++;
                        $fullChildren16Services = $fullChildren16Services->concat($soc4ids);
                    }
        ...
        ) = $this->getCountsByProfileField('6g6x', 'iNHa', [366, 370], $request, 'contains');
        ...
        if ($new) {
            ...
            ) = $this->getCountsByProfileField('6g6x', 'iNHa', [366, 370], $request, 'contains', null, false, true);
        } else {
        ...
        list(
            ...
            $parentLegalWomen,
            $parentLegalServices
        ) = $this->getCountsByProfileField('6g6x', 'aSu3', [366, 370], $request, 'contains');
        ...
        if ($new) {
            list(
                ...
                $parentLegalMenNew,
                $parentLegalWomenNew
            ) = $this->getCountsByProfileField('6g6x', 'aSu3', [366, 370], $request, 'contains', null, false, true);
        } else {
        ...
        $detected = $detectedQuery->count(DB::raw('distinct users.id'));
        ...
        $overallStartedMDRQuery = User::where('roles', 'like', '%client%')
            ->whereHas('projects', function ($query) {
                $query->where('project_id', 6);
            })
            ->whereNotNull('d.data->kB3w');

        $this->addDocumentsJoin($overallStartedMDRQuery);
        $overallStartedMDRQuery->groupBy('users.id');

        if ($request->till) {
            $overallStartedMDRQuery->where('d.data->kB3w', '<=', $request->till);
        }

        static::addMDRClause($overallStartedMDRQuery);
        ...
        foreach ($overallStartedMDRQuery->get() as $client) {
        ...
        $vstAdherenceQuery = clone $vstStartedQuery;
            ...
            [
                ...
                'items' => [
                    [
                        [
                            ...
                            'services?projects=6&profileField=6g6x&profileOp=notin&profileValue=HeBk' .$datesQuery
                        ],
                        [
                            $totalVulnerableServices,
                            'услуг предоставлено представителям уязвимых групп (c ТБ и без)',
                            'services?projects=6&vuln=2' . $datesQuery
                        ],
                        [
                            $legalServices,
                    ...
                    [
                        [
                            ...
                            'services?projects=6&parts=366&parts=370&profileField=6g6x&profileValue=iNHa' .
                        ...
                        [
                            ...
                            'clients?project=6&parts=366&parts=370&profileField=6g6x&profileValue=iNHa' .
                                '&profileOp=contains' . $datesQuery,
                            $childrenLegalNew
                        ],
                        [
                    ...
                    [
                        [
                            ...
                            'services?projects=6&parts=366&parts=370&profileField=6g6x&profileValue=aSu3' .
                                '&profileOp=contains' . $datesQuery
                        ],
                        [
                            $parentsLegal,
                            'родителей получили юридическую помощь',
                            'clients?project=6&parts=366&parts=370&profileField=6g6x&profileValue=aSu3' .
                                '&profileOp=contains' . $datesQuery,
                            $parentsLegalNew
                        ],
                        [
                ...
                'items' => [
                    ...
                    [
                        ...
                        [
                            $legalServicedNL,
                            'представителей уязвимых групп с ТБ получили юридические услуги',
                            'clients?project=6&parts=366&parts=370&vuln=1' .
                            '&profileField3=6g6x&profileValue3=uQRP&profileValue3=gG99' .
                                '&profileValue3=2AJg&profileValue3=YNoK&profileOp3=contains' . $datesQuery
                        ],
                        [
                            $legalServicedNLMale,
                            'мужчин',
                            'clients?project=6&parts=366&parts=370&vuln=1&gender=male' .
                            '&profileField3=6g6x&profileValue3=uQRP&profileValue3=gG99' .
                                '&profileValue3=2AJg&profileValue3=YNoK&profileOp3=contains' . $datesQuery
                        ],
                        [
                            $legalServicedNLFemale,
                            'женщин',
                            'clients?project=6&parts=366&parts=370&vuln=1&gender=female' .
                            '&profileField3=6g6x&profileValue3=uQRP&profileValue3=gG99' .
                                '&profileValue3=2AJg&profileValue3=YNoK&profileOp3=contains' . $datesQuery
                        ],
                        [
